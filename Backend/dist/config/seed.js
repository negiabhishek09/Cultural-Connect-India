...
function seed() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        ].map((c) => (Object.assign(Object.assign({}, c), { slug: c.name.toLowerCase(), description: `Explore ${c.name.toLowerCase()} from across India` })));
        const categories = yield Category_model_1.Category.insertMany(categoriesData);
        ...
        const states = yield State_model_1.State.insertMany(statesData);
        ...
        const priya = yield User_model_1.User.create({
            name: 'Priya Sharma',
        ...
        const abhishek = yield User_model_1.User.create({
            name: 'Abhishek Singh',
        ...
        const anjali = yield User_model_1.User.create({
            name: 'Anjali Reddy',
        ...
        const owner1 = yield User_model_1.User.create({
            name: 'Ramesh Kumawat',
        ...
        const owner2 = yield User_model_1.User.create({
            name: 'Suresh Patel',
        ...
        const businesses = yield Business_model_1.Business.insertMany(businessesData);
...
seed()
    ...
    .finally(() => (0, database_1.disconnectDB)());
